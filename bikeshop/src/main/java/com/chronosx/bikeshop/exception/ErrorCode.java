...
public enum ErrorCode {
    ...
    USERNAME_DUPLICATED(1039, "username is duplicated", HttpStatus.BAD_REQUEST),
    USERNAME_NOT_FOUND(1040, "username is not found", HttpStatus.BAD_REQUEST),
    PRODUCT_CATEGORY_ID_NOT_FOUND(1041, "product category id not found", HttpStatus.BAD_REQUEST),
    PAYMENT_METHOD_ID_NOT_FOUND(1042, "payment method id not found", HttpStatus.BAD_REQUEST),
    OUT_OF_STOCK(1043, "%s is out of stock", HttpStatus.BAD_REQUEST),
    CANT_SEND_MAIL(1044, "can't send email", HttpStatus.BAD_REQUEST),
    PAYPAL_TOKEN_NOT_VALID(1045, "paypal token not valid", HttpStatus.BAD_REQUEST),
    PAYPAL_TOKEN_DENIED(1046, "paypal token not approved", HttpStatus.BAD_REQUEST),
    NOTIFICATION_ID_NOT_FOUND(1047, "notification id not found", HttpStatus.BAD_REQUEST),
    PRODUCT_CATEGORY_NAME_EXISTED(1048, "product category name existed", HttpStatus.BAD_REQUEST),
    PRODUCT_SUB_CATEGORY_NAME_EXISTED(1049, "product sub category name existed", HttpStatus.BAD_REQUEST),
    ;
