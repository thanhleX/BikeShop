...
public interface ProductSubCategoryRepository extends JpaRepository<ProductSubCategory, Long> {
    ...
    @Query("select a from ProductSubCategory a where a.productCategory.name =?1 and a.isActive = true")
    Page<ProductSubCategory> findAllProductSubCategoryByProductCategoryNameWithPagination(String productCategoryName, Pageable pageable);
    ...
    boolean existsProductSubCategoriesByName(String name);
}
